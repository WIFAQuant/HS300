...
> （注：
>
> - Ret1M, Ret3M, Ret6M皆由PCT_CHG合成；
> - RealizedVol_3M, RealizedVol_6M皆由UNDERLYINGHISVOL_90D代替。） 
>
...
另外，这种离差过大的数据去极值的时候还会出现一个问题：造成阈值部分出现异常高的“虚假”数据，而这也是我们不愿意看到的。（如下图：营业收入同比增长率经过约束最严格的百分位去极值处理后的分布图👇）
