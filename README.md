...
> 大类因子合成部分的：
>
> - 代码详见“H3 Codes/3 Data Composition.py” 文件。
...
>
>OK，不过其实 pandas.Panel 这个数据格式被淘汰了，未来的pandas会丢弃这个数据格式，应该用MultiIndex DataFrame才对，不过我们先用这个，等做完了（如果做得完）再回来改格式。
>
